...
<body>
    ...
    <form name="update_event" method="post" action="edit_event.php">
        <table class="table">
            <tr>
                <td>Nama Acara</td>
                <td><input type="text" class="form-control" name="event_name" value="<?php echo $event_name;?>" required></td>
            </tr>
            <tr>
                <td>Tanggal</td>
                <td><input type="date" class="form-control" name="event_date" value="<?php echo $event_date;?>" required></td>
            </tr>
            <tr>
                <td>Waktu</td>
                <td><input type="time" class="form-control" name="event_time" value="<?php echo $event_time;?>" required></td>
            </tr>
            <tr>
                <td>Deskripsi</td>
                <td><textarea class="form-control" name="event_description" required><?php echo $event_description;?></textarea></td>
            </tr>
            <tr>
                <td>Organizer ID</td>
                <td><input type="text" class="form-control" name="organizer_id" value="<?php echo $organizer_id;?>" required></td>
            </tr>
            <tr>
